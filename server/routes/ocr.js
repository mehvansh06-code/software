  ...
  try {
    ...
    if (isBOE) {
      data = {
        ...
        penalty: parsed.penalty ?? null,
        fine: parsed.fine ?? null,
        gst: parsed.gst ?? null,
      ...
      data = {
        ...
        portCode: parsed.portCode ?? null,
        incoTerm: parsed.incoTerm ?? null,
        fobValueFC: parsed.fobValueFC ?? parsed.invoiceValue ?? null,
        fobValueINR: parsed.fobValueINR ?? null,
        exchangeRate: parsed.exchangeRate ?? null,
        dbk: parsed.dbk ?? null,
        rodtep: parsed.rodtep ?? null,
        confidence: parsed.confidence ?? null,
        source: parsed.source ?? null,
      };
    } else {
